    ...
    <div id="masthead">
      <ul>
        <#if "Y" == (userPreferences.COMPACT_HEADER)?default("N")>
            <#if shortcutIcon?has_content>
                <#if organizationLogoLinkURL?has_content>
                    <li><a href="<@ofbizUrl>${logoLinkURL}</@ofbizUrl>"><img alt="${(layoutSettings.companyName)!"OFBiz"}" src="<@ofbizContentUrl>${StringUtil.wrapString(organizationLogoLinkURL)}</@ofbizContentUrl>" height="16px" width="16px"></a></li>
                    <#else>
        ...
        <#else>
          ...
          <#if headerImageUrl??>
                <#if organizationLogoLinkURL?has_content>
                    <li><a href="<@ofbizUrl>${logoLinkURL}</@ofbizUrl>"><img alt="${(layoutSettings.companyName)!"OFBiz"}" src="<@ofbizContentUrl>${StringUtil.wrapString(organizationLogoLinkURL)}</@ofbizContentUrl>" height="60"></a></li>
                    <#else>
                    <li class="logo-area"><a href="<@ofbizUrl>${logoLinkURL}</@ofbizUrl>"><img alt="${(layoutSettings.companyName)!"OFBiz"}" src="<@ofbizContentUrl>${StringUtil.wrapString(headerImageUrl)}</@ofbizContentUrl>"/></a></li>
                </#if>
          </#if>
